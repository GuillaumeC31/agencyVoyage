...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 28 jan. 2020 à 15:50
...
INSERT INTO `travels` (`id`, `entitled`, `hostel_name`, `country_id`, `description`, `term`, `price`, `picture`, `actived`) VALUES
(7, 'Escapade en amoureux à Paris', 'Hôtel de la tour Eiffel', 75, 'Qui n\'as jamais rêvé de passer un weekend en amoureux dans la plus romantique des villes. Avec un hôtel à deux pas de la tour Eiffel.', '2 jours', '800.99', 'Escapade-en-amoureux-a-Paris-hotel_001.jpg', 'on'),
(8, 'Bain de soleil à Marseille', 'Hôtel du Sud', 75, 'Qui n\'a jamais rêvé de quitter la grisaille et partir faire le plein de soleil. Venez profiter d\'une semaine dans le sud!', '1 semaine', '799.31', 'Bain-de-soleil-a-Marseille-hotel_002.jpg', 'on'),
(9, 'Farniente et séjour culturelles à San José', 'Hôtel del Sol', 54, 'Découvrez un pays d\'Amérique centrale recouvert d\'une forêt tropicale humide et situé entre la mer des Caraïbes et l\'océan Pacifique. Bien que sa capitale, San José, abrite des institutions culturelles comme le musée de l\'Or précolombien, le Costa Rica est connu pour ses plages, ses volcans et sa biodiversité.', '2 semaines', '1463.11', 'Farniente-et-sejour-culturelles-a-San-Jose-hotel_003.jpg', 'on'),
