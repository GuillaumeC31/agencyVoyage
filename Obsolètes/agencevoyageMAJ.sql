...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 27 jan. 2020 à 17:47
...
INSERT INTO `sejours` (`id`, `title`, `hotel`, `pays_id`, `description`, `duree`, `tarif`, `photo`, `active`) VALUES
(3, '', 'Hotel de la', 203, 'Passer la tête? Pour me prendre une flêche dedans? Non merci! Sans vouloir la ramener la seule différence concrète avec les briques c’est que vous appelez ça des tartes. Alors dites vous que c’est un combat réel et montrez-moi ce que vous avez dans l’slibard! Qu’est ce que vous nous chantez? Vous êtes pas gaulois que je sache! Ah mais non, on va se faire tuer là! Allez en garde ma mignonne!', '1', '10', '1580140783-vacancesEte.jpg', 0),
(4, '', 'hotel badaboum baboum', 1, 'Passer la tête? Pour me prendre une flêche dedans? Non merci! Sans vouloir la ramener la seule différence concrète avec les briques c’est que vous appelez ça des tartes. Alors dites vous que c’est un combat réel et montrez-moi ce que vous avez dans l’slibard! Qu’est ce que vous nous chantez? Vous êtes pas gaulois que je sache! Ah mais non, on va se faire tuer là! Allez en garde ma mignonne!', '2 semaines', '10', '1580141088-vacancesToussaint.jpg', 0),
(5, '', 'hotel badaboum baboum', 1, 'Passer la tête? Pour me prendre une flêche dedans? Non merci! Sans vouloir la ramener la seule différence concrète avec les briques c’est que vous appelez ça des tartes. Alors dites vous que c’est un combat réel et montrez-moi ce que vous avez dans l’slibard! Qu’est ce que vous nous chantez? Vous êtes pas gaulois que je sache! Ah mais non, on va se faire tuer là! Allez en garde ma mignonne!', '2 semaines', '10', '1580141261-vacancesToussaint.jpg', 0),
(6, '', 'hotel badaboum baboum', 1, 'Passer la tête? Pour me prendre une flêche dedans? Non merci! Sans vouloir la ramener la seule différence concrète avec les briques c’est que vous appelez ça des tartes. Alors dites vous que c’est un combat réel et montrez-moi ce que vous avez dans l’slibard! Qu’est ce que vous nous chantez? Vous êtes pas gaulois que je sache! Ah mais non, on va se faire tuer là! Allez en garde ma mignonne!', '2 semaines', '10 000,50', '1580141296-vacancesToussaint.jpg', 0);
